...
function Segment({ value, label }: { value: string; label: string }) {
  return (
    <div className="flex flex-col items-center gap-1 rounded-xl border border-black/5 bg-white px-3 py-2 shadow-[0_2px_10px_rgb(0,0,0,0.04)] sm:px-4 sm:py-3">
...
export function CountdownTimer({ targetDate }: CountdownTimerProps) {
  ...
  if (timeLeft === null) {
    return <p className="text-sm font-medium text-olympiad-800">The event has started.</p>;
  }
